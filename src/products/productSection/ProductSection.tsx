  ...
  const products: IProduct[] = [
    {
      ...
      description: [
          "Generiere dir für dein Entwicklungsprojekte eine Farbpalette mit ausreichend Variation.",
    ...
    },
    {
      ...
      description: [
          ...
          "Ob für deinen eigenen Passwortalgorithmus, Wörter alphabetisch sortieren oder den Escape Room, meiner Meinung nach ist dies eine sehr nützlicher Fähigkeit.",
